...
public class PriceWatcherUI extends JPanel implements ListSelectionListener {
	private JList list;
	...
	class DeleteButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			/*
			 * This method can be called only if there's a valid selection, so go ahead and
	...
	protected static ImageIcon createImageIcon(String imageName) {
		...
		java.net.URL imageURL = PriceWatcherUI.class.getResource(imgLocation);
	...
	private static void createAndShowGUI() {
		...
		JComponent newContentPane = new PriceWatcherUI();
